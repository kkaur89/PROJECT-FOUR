          ...
          <Card.Body>
            ...
            <div className="video-com">
              <Card style={{ width: '100%' }}>
                <h4>Comments: </h4><br /> 
                <h5>
                  {/* {video.comments.length < 1 ? <p>No comments</p>
                    :
                    video.comments[0].text - video.comments[0].owner.username} <br /><br />
                  {video.comments.length < 2 ? video.comments[0].text - video.comments[0].owner.username
                    :
                    video.comments[0].text - video.comments[0].owner.username, video.comments[1].text - video.comments[1].owner.username} */}
                  {video.comments[0].text} - {video.comments[0].owner.username} <br /><br />
